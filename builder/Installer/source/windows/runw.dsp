...
# ADD LINK32 kernel32.lib user32.lib zlibstat.lib wsock32.lib /nologo /subsystem:windows /machine:I386 /out:"..\..\support\runw.exe" /libpath:"f:\zlib113\zlibstat"
...
# ADD LINK32 kernel32.lib user32.lib zlibstat.lib wsock32.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\..\support\runw_d.exe" /pdbtype:sept /libpath:"f:\zlib113\zlibstat"
